...
class T5LayerCrossAttention(nn.Module):
    ...
    def forward(
        ...
        # add attentions if we outpurelative_attention_biast them
...
class AdapterModel(nn.Module):
    def __init__(self, config):
        ...
        #     [T5Block(self.config, has_relative_attention_bias=True) for i in range(self.adapter_num * self.pool_size)]
        # )
        self.adapters = nn.ModuleList(
    ...
    def forward(self, pretrained_model_outputs, year):
    ...
    def get_adapter_idx(self, layer, num):
        return self.pool_size * layer + num
